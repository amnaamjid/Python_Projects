...
class Calculator:
    ...
    def __init__(self, master):
        ...
        master.geometry("360x430+0+0")
        master.config(bg="gray")
        master.resizable(False,False)
        
        self.equation = StringVar()
        self.entry_value = ""
        Entry(width=17,bg='#ccddff',font=("Times New Roman, Bold", 28),textvariable=self.equation).place(x=0,y=0)
...
#icon
app_icon = PhotoImage(file="calculator.png")
